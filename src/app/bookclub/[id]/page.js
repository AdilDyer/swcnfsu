    ...
    <div className="eventPage">
      ...
      <div className="contentDiv">
        ...
        <p>
          ...
          college's open area, setting the perfect backdrop for an enriching
          discussion on "Discovering New Genres." The session was filled with
          excitement as members gathered to explore the vast and diverse world
          of literary genres.
          <span>Agenda</span>
          <ol>
          ...
          <span> 1. Introduction to Literary Genres</span> We began the meeting
          with a brief introduction to the concept of literary genres. Genres
          are categories that define a book based on its narrative style,
          content, and form. The main purpose was to understand the different
          genres and how they can shape our reading experiences.
          <span>Key Points:</span>
          <ol>
            <li> Definition of literary genres.</li>
            <li>Importance of genres in literature.</li>
            <li>
              Examples of major genres: Fiction, Non-Fiction, Mystery, Fantasy,
              Science Fiction, Historical Fiction, Romance, and more.
            </li>
          </ol>
          <span>2. Exploring Unfamiliar Genres</span>
          Each member was encouraged to delve into genres they had little to no
          experience with. This segment aimed to broaden our literary horizons
          and introduce us to new and exciting forms of storytelling.
          <span>Highlighted Genres:</span>
          <ul>
            <li>
              Cyberpunk: A sub-genre of science fiction focused on futuristic,
              dystopian societies dominated by computer technology and hackers.
            </li>
            <li>
          ...
          explored. This was a highly interactive session where we learned from
          each other's reading journeys.
          <span>Insights:</span>
          <ul>
            <li>
            ...
            <li>
              ...
              were a hit, with many members expressing newfound appreciation for
              the genre.
            </li>
            <li>
          ...
          We concluded the meeting by summarizing our discoveries and discussing
          how we could incorporate this newfound knowledge into our future
          reading endeavors.
          <span>Key Takeaways:</span>
          <ul>
            <li>
              Open-Minded Reading: Embracing new genres can significantly enrich
              our reading experiences and knowledge.
            </li>
            <li>
          ...
          <span>
            ...
            environment, making the experience even more memorable. As we parted
            ways, there was a shared sense of excitement about the endless
            possibilities that await us in the world of books.
          </span>
        </p>
        <br />
              <h4>~ Event Gallery ~ </h4>
