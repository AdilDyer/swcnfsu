...
//using new code (optimised using claude ) to handle the demounting of useffects to not have that extra height of login page
...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const skewScrolling = () => {
      ...
      //removed the skew segment from transform :: skewY(${skew}deg)
      //loop vai raf
      animationFrameId = requestAnimationFrame(skewScrolling);
    };
